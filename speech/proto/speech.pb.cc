...
const uint32_t TableStruct_speech_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionReq, _impl_._has_bits_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionReq, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionReq, _impl_.request_id_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionReq, _impl_.speech_content_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionReq, _impl_.user_id_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionReq, _impl_.session_id_),
  ~0u,
  ~0u,
  0,
  1,
  ...
  ~0u,  // no _weak_field_map_
  ~0u,  // no _inlined_string_donated_
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionRsp, _impl_.request_id_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionRsp, _impl_.success_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionRsp, _impl_.errmsg_),
  PROTOBUF_FIELD_OFFSET(::XuChat::SpeechRecognitionRsp, _impl_.recognition_result_),
};
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 10, -1, sizeof(::XuChat::SpeechRecognitionReq)},
  { 14, -1, -1, sizeof(::XuChat::SpeechRecognitionRsp)},
};
...
const char descriptor_table_protodef_speech_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "Service\022O\n\021SpeechRecognition\022\034.XuChat.Sp"
  "eechRecognitionReq\032\034.XuChat.SpeechRecogn"
  "itionRspB\003\200\001\001b\006proto3"
  ;
static ::_pbi::once_flag descriptor_table_speech_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_speech_2eproto = {
    false, false, 381, descriptor_table_protodef_speech_2eproto,
    "speech.proto",
